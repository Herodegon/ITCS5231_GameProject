...
public class PlayerController : MonoBehaviour
{
    ...
    public Dictionary<FishStats, int> fishCaught = new();  // Inventory of fish caught
    ...
    public void ExitCombat()
    {
        ...
        if (fish.isCaptured)
        {
            FishStats fishStats = new FishStats(fish.fishName, fish.fishType);
            if (fishCaught.ContainsKey(fishStats))
            {
                fishCaught[fishStats]++;
            }
            else
            {
